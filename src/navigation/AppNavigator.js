...
// Importuojame pagrindinius ekranus
...
// Importuojame Nustatymų ekranus
...
import ImportScreen from '../screens/settings/ImportScreen'; // NAUJAS

// Importuojame kitus navigatorius
...
function StartStack() {
    return (
        <Stack.Navigator screenOptions={stackScreenOptions}>
            <Stack.Screen name="Start" component={StartScreen} options={{ title: 'Pradžia' }} />
            <Stack.Screen name="AddInvoice" component={AddInvoiceScreen} options={{ title: 'Nauja Gauta Sąskaita' }} />
            <Stack.Screen name="AddDraftInvoice" component={AddDraftInvoiceScreen} options={{ title: 'Nauja Išrašoma Sąskaita' }} />
        </Stack.Navigator>
    );
}

function ReceivedInvoicesStack() {
    return (
        <Stack.Navigator screenOptions={stackScreenOptions}>
            <Stack.Screen name="ReceivedInvoices" component={ReceivedInvoicesScreen} options={{ title: 'Gautos Sąskaitos' }} />
        </Stack.Navigator>
    );
}

function DraftInvoicesStack() {
    return (
        <Stack.Navigator screenOptions={stackScreenOptions}>
            <Stack.Screen name="DraftInvoices" component={DraftInvoicesScreen} options={{ title: 'Išrašomos Sąskaitos' }} />
        </Stack.Navigator>
    );
}
...
function ReportsStack() {
    return (
        <Stack.Navigator screenOptions={stackScreenOptions}>
            <Stack.Screen name="Reports" component={ReportsScreen} options={{ title: 'Ataskaitos' }} />
        </Stack.Navigator>
    );
}
...
function SettingsStack() {
    return (
        <Stack.Navigator screenOptions={stackScreenOptions}>
            <Stack.Screen name="SettingsDashboard" component={SettingsDashboardScreen} options={{ title: 'Nustatymai' }} />
            ...
            <Stack.Screen name="Import" component={ImportScreen} options={{ title: 'Duomenų Importavimas' }} />
            <Stack.Screen name="GeneralSettings" component={GeneralSettingsScreen} options={{ title: 'Bendri Nustatymai' }} />
